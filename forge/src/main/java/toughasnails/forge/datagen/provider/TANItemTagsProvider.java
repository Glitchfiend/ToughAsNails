...
public class TANItemTagsProvider extends ItemTagsProvider
{
    ...
    protected void addTags(HolderLookup.Provider provider)
    {
        ...
        this.tag(ModTags.Items.ONE_THIRST_DRINKS).add(TANItems.DIRTY_WATER_BOTTLE, TANItems.LEATHER_DIRTY_WATER_CANTEEN, TANItems.COPPER_DIRTY_WATER_CANTEEN, TANItems.IRON_DIRTY_WATER_CANTEEN, TANItems.GOLD_DIRTY_WATER_CANTEEN, TANItems.DIAMOND_DIRTY_WATER_CANTEEN, TANItems.NETHERITE_DIRTY_WATER_CANTEEN);
        ...
        this.tag(ModTags.Items.TWENTY_HYDRATION_DRINKS).add(Items.POTION, TANItems.LEATHER_WATER_CANTEEN, TANItems.COPPER_WATER_CANTEEN, TANItems.IRON_WATER_CANTEEN, TANItems.GOLD_WATER_CANTEEN, TANItems.DIAMOND_WATER_CANTEEN, TANItems.NETHERITE_WATER_CANTEEN, TANItems.CHORUS_FRUIT_JUICE);
        this.tag(ModTags.Items.THIRTY_HYDRATION_DRINKS).add(Items.MILK_BUCKET);
        this.tag(ModTags.Items.FOURTY_HYDRATION_DRINKS).add(TANItems.PUMPKIN_JUICE);
        this.tag(ModTags.Items.FIFTY_HYDRATION_DRINKS).add(TANItems.APPLE_JUICE);
        this.tag(ModTags.Items.SIXTY_HYDRATION_DRINKS).add(TANItems.MELON_JUICE);
