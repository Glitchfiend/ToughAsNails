...
public class CraftingUtil
{
    ...
    public static final File RECIPES_DIR = new File(ToughAsNails.configDirectory, "recipes");;
    ...
    public static boolean doRegistration = true;
    ...
    static
    {
        ...
        {
            ToughAsNails.logger.error("Could not delete default biome config directory!");
        }
    }
    ...
    private static void registerRecipe(ResourceLocation location, IRecipe recipe)
    {
        ...
        if (generateJson && (recipe instanceof ShapedRecipes || recipe instanceof ShapelessRecipes))
        {
            ...
            {
                ToughAsNails.logger.error("Could not write recipe to file " + recipeFile.getName());
            }
        }
    ...
    {
        ResourceLocation baseLoc = new ResourceLocation(ToughAsNails.MOD_ID, output.getItem().getRegistryName().getResourcePath());
        ...
        {
            index++;
            recipeLoc = new ResourceLocation(ToughAsNails.MOD_ID, baseLoc.getResourcePath() + "_" + index);
        }
