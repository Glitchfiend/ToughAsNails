...
public class ItemTANSpawnEgg extends Item
{
    ...
    {
        int tanEntityId = stack.getMetadata();
        String entityName = ModEntities.idToTANEntityName.get(tanEntityId);
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
                {
                    ...
                    {
                        Entity entity = spawnTANCreature(worldIn, itemStackIn.getMetadata(), (double)blockpos.getX() + 0.5D, (double)blockpos.getY() + 0.5D, (double)blockpos.getZ() + 0.5D);
