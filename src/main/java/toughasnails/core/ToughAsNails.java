...
@Mod(modid = ToughAsNails.MOD_ID, version = ToughAsNails.MOD_VERSION, name = ToughAsNails.MOD_NAME, dependencies = "required-after:forge@[14.21.0.2340,)", guiFactory = ToughAsNails.GUI_FACTORY)
