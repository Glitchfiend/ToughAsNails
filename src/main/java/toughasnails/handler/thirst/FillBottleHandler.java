...
public class FillBottleHandler 
{
    ...
    public void onRightClickCauldron(PlayerInteractEvent.RightClickBlock event)
    {
        ...
        if (player.getHeldItem(event.getHand()).getItem() == Items.GLASS_BOTTLE && state.getBlock() instanceof BlockCauldron && SyncedConfig.getBooleanValue(GameplayOption.ENABLE_THIRST))
        {
